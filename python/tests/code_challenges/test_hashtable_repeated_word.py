import pytest
from code_challenges.hashtable_repeated_word import first_repeated_word, word_count
...
def test_word_count():
    txt = """
  apple aPp. Apple apple apple...
  banana! ap.ple app      ,  APPLE
  Banana Slug App
  """

    actual = word_count(txt)
    expected = {'apple': 6, 'app': 3, 'banana': 2, 'slug': 1}
    assert actual == expected
